...
class _PageState extends State<RegisterPage> {
  ...
  String? _password, _email, _firstName, _lastName;
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (value) => (value?.isNotEmpty ?? false) ? null : "Please enter a First name",
          )
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (value) => (value?.isNotEmpty ?? false) ? null : "Please enter a Last name",
          )
        ],
      ),
    );
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          TextFormField(
            ...
            validator: (val) {
              return (val?.length ?? 0) < 5 ? "password must have valid" : null;
            },
          )
        ],
      ),
  ...
  Widget privacyPolicyLinkAndTermsOfService() {
    return Container(
      ...
      child: Center(
          child: Text.rich(
              TextSpan(text: 'By Creating an account, you agree to our', style: TextStyle(fontSize: 14, color: Colors.blueGrey), children: <TextSpan>[
        TextSpan(
            text: ' User Agreement',
            style: TextStyle(
              fontSize: 14,
        ...
        TextSpan(text: ' And acknowledge reading our ', style: TextStyle(fontSize: 14, color: Colors.blueGrey), children: <TextSpan>[
          TextSpan(
